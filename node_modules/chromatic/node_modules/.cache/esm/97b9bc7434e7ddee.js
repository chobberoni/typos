let debug,createClient,stripAnsi,format,errorSerializer;_34e‍.x([["createLogger",()=>createLogger]]);_34e‍.w("debug",[["default",["debug"],function(v){debug=v}]]);_34e‍.w("node-loggly-bulk/lib/loggly/client",[["createClient",["createClient"],function(v){createClient=v}]]);_34e‍.w("strip-ansi",[["default",["stripAnsi"],function(v){stripAnsi=v}]]);_34e‍.w("util",[["format",["format"],function(v){format=v}]]);_34e‍.w("./logSerializers",[["errorSerializer",["errorSerializer"],function(v){errorSerializer=v}]]);/* eslint-disable no-console */
...
const handleRejection = reason => _34e‍.g.console.error('Unhandled promise rejection:', reason);
...
const logVerbose = (type, args) => {
  ...
  const log = type => (...args) => {
    ...
    else _34e‍.g.console[type](...messages);
