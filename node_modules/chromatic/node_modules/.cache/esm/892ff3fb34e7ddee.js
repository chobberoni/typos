let envCi,dedent,getBranch,getCommit;_34e‍.x([["getCommitAndBranch",()=>getCommitAndBranch]]);_34e‍.w("env-ci",[["default",["envCi"],function(v){envCi=v}]]);_34e‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);_34e‍.w("./git",[["getBranch",["getBranch"],function(v){getBranch=v}],["getCommit",["getCommit"],function(v){getCommit=v}]]);
...
const notHead = b => {
  ...
  return b;
       ...
       async function getCommitAndBranch({ patchBaseRef, inputFromCI, log } = {}) {
