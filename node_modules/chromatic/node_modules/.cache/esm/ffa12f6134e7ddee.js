let retry,fs,fetch,pLimit,progress;_34e‍.x([["default",()=>uploadFiles]]);_34e‍.w("async-retry",[["default",["retry"],function(v){retry=v}]]);_34e‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_34e‍.w("node-fetch",[["default",["fetch"],function(v){fetch=v}]]);_34e‍.w("p-limit",[["default",["pLimit"],function(v){pLimit=v}]]);_34e‍.w("progress-stream",[["default",["progress"],function(v){progress=v}]]);





               async function uploadFiles({ env, log }, files, onProgress) {
