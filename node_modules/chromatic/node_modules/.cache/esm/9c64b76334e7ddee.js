let execa,gql,EOL,dedent;_34e‍.x([["FETCH_N_INITIAL_BUILD_COMMITS",()=>FETCH_N_INITIAL_BUILD_COMMITS],["getVersion",()=>getVersion],["getCommit",()=>getCommit],["getBranch",()=>getBranch],["getBaselineCommits",()=>getBaselineCommits],["isUpToDate",()=>isUpToDate],["isClean",()=>isClean],["getUpdateMessage",()=>getUpdateMessage],["findMergeBase",()=>findMergeBase],["checkout",()=>checkout],["checkoutPrevious",()=>checkoutPrevious],["discardChanges",()=>discardChanges]]);_34e‍.w("execa",[["default",["execa"],function(v){execa=v}]]);_34e‍.w("fake-tag",[["default",["gql"],function(v){gql=v}]]);_34e‍.w("os",[["EOL",["EOL"],function(v){EOL=v}]]);_34e‍.w("ts-dedent",[["default",["dedent"],function(v){dedent=v}]]);
...
async function step(
  ...
  return step({ client, log }, limit * 2, {
    ...
    commitsWithoutBuilds: [...commitsWithoutBuilds, ...newCommitsWithoutBuilds],
       ...
       async function getBaselineCommits(
  { client, log },
